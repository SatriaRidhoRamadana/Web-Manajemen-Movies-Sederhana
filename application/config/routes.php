...
$route['api/showtimes'] = '';
$route['api/showtimes/(:num)'] = '';
$route['api/bookings'] = '';
$route['api/bookings/(:num)'] = '';
$route['api/users'] = 'api/users';
$route['api/users/(:num)'] = 'api/users_detail/$1';

// Movies frontend routes
$route['movies'] = 'movies/index';
$route['movies/create'] = 'movies/create';
$route['movies/edit/(:num)'] = 'movies/edit/$1';
$route['movies/delete/(:num)'] = 'movies/delete/$1';
