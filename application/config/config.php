...
|
*/
$config['base_url'] = 'http://localhost:8074/API/API/';
...
| JWT Key
|--------------------------------------------------------------------------
| Secret used to sign JWT tokens. Change this to a strong random value.
*/
$config['jwt_key'] = 'sargeant_nate_higgerson';
...
$config['sess_save_path'] = dirname(__DIR__) . '/cache/sessions';
